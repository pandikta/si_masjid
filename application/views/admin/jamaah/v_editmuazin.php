    ...
    <div class="content">
        <div class="page-inner">
            <div class="page-header">
                <h4 class="page-title">Edit Muazin</h4>
                    ...
                    <div class="row">
                        ...
                        <form class="col-md-12 col-lg-4" action="<?= base_url('admin/jamaah/edit_muazin/') . $tampilmuazin['id']; ?>" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="alamat" class="form-control" placeholder="masukkan alamat" value="<?= $tampilmuazin['alamat']; ?>" required>

                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 col-form-label">No Telepon</label>
                                <input type="number" name="no_hp" class="form-control" placeholder="no telepon" value="<?= $tampilmuazin['no_hp']; ?>" required>
